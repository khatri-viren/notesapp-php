...
**Description:**
This is a simple full-stack notes application built using PHP and MySQL. Users can perform CRUD (Create, Read, Update, Delete) operations on their notes. Additionally, it provides basic user functionalities such as account creation, form validation, account activation via email, secure password storage, and a "stay logged in" feature using cookies. 
